...
public class Lektira {
   ...
   public static void main(String[] args) {
      ...
      for(int i = 0; i < arr.length - 2; i++)
        ...
        public static void gen(int start1, int start2, int end, String input, TreeSet<String> tree){
            if(start2 != end){
        ...
        public static String breakUp(int start1, int start2, int end, String input){
